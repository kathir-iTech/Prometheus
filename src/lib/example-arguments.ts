// src/lib/example-arguments.ts

import type { TrackId } from '@/types/argument';

export const EXAMPLE_ARGUMENTS: Record<TrackId, string> = {
  scientific_reasoning:
    'Climate change is not caused by humans because the sun is getting hotter, and hotter sunlight would explain rising global temperatures.',
  historical_analysis:
