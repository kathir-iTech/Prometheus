...
export async function POST(request: Request) {
  try {
    ...
    const SYSTEM_INSTRUCTION = `Evaluate the student's answer to a transfer question. The student has just completed an improved rescan on VivaMind, showing they corrected their understanding.
